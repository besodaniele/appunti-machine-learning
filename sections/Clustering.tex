...
La similarità tra oggetti può essere difficile da definire formalmente, ma al livello può essere intuitivo (infatti vanno effettuate analisi dopo aver effettuato il clustering).
\\
\\
