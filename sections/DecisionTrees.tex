...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.6\textwidth]{pictures/split/split1.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.4\textwidth]{pictures/split/entropia.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{pictures/split/humidityWind.png}
...
\[
Split\ Information(S, A) = - \sum_{v \in Values(A)} \frac{|S_v|}{|S|} \log_2 \frac{|S_v|}{|S|}
\]
