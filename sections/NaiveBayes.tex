...
Se uno degli attributi ha una combinazione di valori che non appare nel dataset di addestramento per una certa classe, la probabilità condizionata stimata sarà zero.
