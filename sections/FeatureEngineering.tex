...
\end{enumerate}
Con il metodo $2$ e $3$ ho il problema di \textbf{curse of dimensionality}, ovvero il numero di campioni (necessari per avere la stessa accuratezza) cresce esponenzialmente con il numero di feature. Ma nella pratica il numero di esempi di training è fisso, dunque le performance in generale calano per alti numeri di features.
In molti casi l'informazione che viene persa dalla rimozione di variabili viene compensata da un miglior training in uno spazio di dimensione minore.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{pictures/RE/proiezione.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{pictures/RE/pca.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pictures/RE/pcaVarianza.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[width=0.7\textwidth]{pictures/RE/iris.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pictures/RE/irisDistribution.png}
	\caption{Distribuzione della lunghezza del petalo per le tre specie di iris}
	\label{fig:irisPetalLength}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pictures/RE/irisDistrAttributes.png}
	\caption{Distribuzione delle feature del dataset iris}
	\label{fig:irisPCA}
\end{figure}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{pictures/RE/PCAiris.png}
