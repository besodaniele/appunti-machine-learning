...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{pictures/Percettrone/percettrone.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{pictures/Percettrone/classificazionePercettrone.png}
